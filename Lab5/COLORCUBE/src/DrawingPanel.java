...
for (int i=0; i<Math.min(table1.length, table4.length); i++){//1-3 back face
			
			drawLine(table1[i].x, table1[i].y, table1[i].zbuf, table4[Math.min(table1.length, table4.length)-i-1].x, table4[Math.min(table1.length, table4.length)-i-1].y, table4[Math.min(table1.length, table4.length)-i-1].zbuf, pixs, 1);
		}
		for (int i=0; i<Math.min(table2.length, table3.length); i++){//1-3 back face
			
			drawLine(table2[i].x, table2[i].y, table2[i].zbuf, table3[Math.min(table2.length, table3.length)-i-1].x, table3[Math.min(table2.length, table3.length)-i-1].y, table3[Math.min(table2.length, table3.length)-i-1].zbuf, pixs, 1);
		}
		for (int i=0; i<Math.min(table5.length, table8.length); i++){
			
			drawLine(table5[i].x, table5[i].y, table5[i].zbuf, table8[Math.min(table5.length, table8.length)-i-1].x, table8[Math.min(table5.length, table8.length)-i-1].y, table8[Math.min(table5.length, table8.length)-i-1].zbuf, pixs, 2);
		}
		for (int i=0; i<Math.min(table6.length, table7.length); i++){
			
			drawLine(table6[i].x, table6[i].y, table6[i].zbuf, table7[Math.min(table6.length, table7.length)-i-1].x, table7[Math.min(table6.length, table7.length)-i-1].y, table7[Math.min(table6.length, table7.length)-i-1].zbuf, pixs, 2);
		}	
		for (int i=0; i<Math.min(table8.length, table12.length); i++){
			
			drawLine(table8[i].x, table8[i].y, table8[i].zbuf, table12[Math.min(table8.length, table12.length)-i-1].x, table12[Math.min(table8.length, table12.length)-i-1].y, table12[Math.min(table8.length, table12.length)-i-1].zbuf, pixs, 4);
		}
		for (int i=0; i<Math.min(table4.length, table9.length); i++){
			
			drawLine(table4[i].x, table4[i].y, table9[i].zbuf, table9[i].x, table9[i].y, table9[i].zbuf, pixs, 4);
		}
		for (int i=0; i<Math.min(table6.length, table11.length); i++){
			
			drawLine(table6[i].x, table6[i].y, table6[i].zbuf, table11[i].x, table11[i].y, table11[i].zbuf, pixs, 5);
		}
		for (int i=0; i<Math.min(table10.length, table2.length); i++){
			drawLine(table10[i].x, table10[i].y, table10[i].zbuf, table2[i].x, table2[i].y, table2[i].zbuf, pixs, 5);
		}
		for (int i=0; i<Math.min(table1.length, table9.length); i++){
			drawLine(table1[i].x, table1[i].y, table1[i].zbuf, table9[Math.min(table1.length, table9.length)-i-1].x, table9[Math.min(table1.length, table9.length)-i-1].y, table9[Math.min(table1.length, table9.length)-i-1].zbuf, pixs, 6);
		}
		for (int i=0; i<Math.min(table5.length, table10.length); i++){
			drawLine(table5[i].x, table5[i].y, table5[i].zbuf, table10[i].x, table10[i].y, table10[i].zbuf, pixs, 6);
		}
		for (int i=0; i<Math.min(table12.length, table3.length); i++){
			drawLine(table12[i].x, table12[i].y, table12[i].zbuf, table3[Math.min(table12.length, table3.length)-i-1].x, table3[Math.min(table12.length, table3.length)-i-1].y, table3[Math.min(table12.length, table3.length)-i-1].zbuf, pixs, 3);
		}
		for (int i=0; i<Math.min(table7.length, table11.length); i++){
			drawLine(table7[i].x, table7[i].y, table7[i].zbuf, table11[Math.min(table7.length, table11.length)-i-1].x, table11[Math.min(table7.length, table11.length)-i-1].y, table11[Math.min(table7.length, table11.length)-i-1].zbuf, pixs, 3);
		}
		...
		for (int i=0; i<Math.min(table05.length, table010.length); i++){
			drawLine(table05[i].x, table05[i].y, table05[i].zbuf, table010[i].x, table010[i].y, table010[i].zbuf, pixs, 6);
		}
		for (int i=0; i<Math.min(table012.length, table03.length); i++){
			drawLine(table012[i].x, table012[i].y, table012[i].zbuf, table03[Math.min(table012.length, table03.length)-i-1].x, table03[Math.min(table012.length, table03.length)-i-1].y, table03[Math.min(table012.length, table03.length)-i-1].zbuf, pixs, 3);
		}
		for (int i=0; i<Math.min(table07.length, table011.length); i++){
			drawLine(table07[i].x, table07[i].y, table07[i].zbuf, table011[Math.min(table07.length, table011.length)-i-1].x, table011[Math.min(table07.length, table011.length)-i-1].y, table011[Math.min(table07.length, table011.length)-i-1].zbuf, pixs, 3);
		}
